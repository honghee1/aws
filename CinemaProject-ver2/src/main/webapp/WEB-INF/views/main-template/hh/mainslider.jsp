						...
						<div class="row" >
							<div class="col-md-8 col-sm-12 col-xs-12">
								<div class="title-in">
									...
									<div class="social-btn">
										<a href="https://youtu.be/${Movielist.trailer }" class="parent-btn fancybox-media hvr-grow"><i class="ion-play"></i>Watch
							...
							${f.fileName}</a><br> --%>
									<%-- 	<c:if test="${f.type =='image' }"> --%>
											<img src="fileDown.do?fno=1&mcode=${Movielist.mcode }" style="width: 330px;height: 500px;">
								<%-- 		</c:if> --%>
									<%-- </c:forEach> --%>
								</div>
							</div>
