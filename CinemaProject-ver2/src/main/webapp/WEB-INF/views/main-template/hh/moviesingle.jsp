			...
			<div class="row ipad-width2">
				<div class="col-md-4 col-sm-12 col-xs-12">
					<div class="movie-img sticky-sb">
						<img src="fileDown.do?fno=1&mcode=${requestScope.moviedto.mcode }" alt="">
						<div class="movie-btn">
							<div class="btn-transform transform-vertical red">
								...
								<div>
									<a href="https://youtu.be/${requestScope.moviedto.trailer }"
							...
							<div class="btn-transform transform-vertical">
								<div>
									<a href="/reserveView.do" class="item item-1 yellowbtn"><i
										class="ion-card"></i>Buy ticket</a>
								</div>
								<div>
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="movie-single-ct main-content">
						<h1 class="bd-hd">
							${requestScope.moviedto.title } <span>${requestScope.moviedto.repRlsDate }</span>
						</h1>
						<!-- <div class="social-btn">
							...
							<div class="hover-bnt">
								...
								<div class="hvr-item">
									<a href="#" class="hvr-grow"><i class="ion-social-facebook"></i></a><a
										href="#" class="hvr-grow"><i class="ion-social-twitter"></i></a><a
										href="#" class="hvr-grow"><i class="ion-social-googleplus"></i></a><a
										href="#" class="hvr-grow"><i class="ion-social-youtube"></i></a>
								</div>
							</div>
						</div> -->
						<br>
							...
							<div class="tabs">
								...
								<div class="tab-content">
									<div id="overview" class="tab active">
										<div class="row">
											<div class="col-md-8 col-sm-12 col-xs-12">
												<p>${requestScope.moviedto.plotText }</p>
												...
												<c:forEach var="f" items="${requestScope.Filelist }">
													<a class="img-lightbox" data-fancybox-group="gallery"
														href="fileDown.do?fno=${f.fno}&mcode=${f.mcode}"><img
												...
												<div class="mv-user-review-item">
													...
													<div class="no-star">
														<i class="ion-android-star"></i><i
															class="ion-android-star"></i><i class="ion-android-star"></i><i
															class="ion-android-star"></i><i class="ion-android-star"></i><i
															class="ion-android-star"></i><i class="ion-android-star"></i><i
															class="ion-android-star"></i><i class="ion-android-star"></i><i
											...
											<div class="col-md-4 col-xs-12 col-sm-12">
												<div class="sb-it">
													<h6>Director:</h6>
														...
														<p>${requestScope.moviedto.directorNm }</p>
														<p>${requestScope.moviedto.directorEnNm }</p>
													
												</div>
												<div class="sb-it">
													<h6>Stars:</h6>
													<p>
														${requestScope.moviedto.actorNm }
													</p>
													<p>
														${requestScope.moviedto.actorEnNm }
													</p>
												</div>
												<div class="sb-it">
													<h6>Genres:</h6>
													<p>
														${requestScope.moviedto.genre }
													</p>
												</div>
												<div class="sb-it">
													<h6>Release Date:</h6>
													<p>${requestScope.moviedto.repRlsDate }</p>
												</div>
												<div class="sb-it">
													<h6>Run Time:</h6>
													<p>141 min</p>
												...
												<div class="sb-it">
													<h6>상영 등급:</h6>
													<p>${requestScope.moviedto.rating }</p>
												</div>
												<div class="sb-it">
													<h6>Plot Keywords:</h6>
													<p class="tags">
														<span class="time">${requestScope.moviedto.keywords }</span>
													</p>
												</div>
												<!-- <div class="ads">
									...
									<div id="reviews" class="tab review">
										<div class="row">
											...
											<div class="topbar-filter">
												...
												<label>Filter by:</label><select><option
														value="popularity">Popularity Descending</option>
											...
											<div class="topbar-filter">
												<label>Reviews per page:</label><select><option
														value="range">5 Reviews</option>
													<option value="saab">10 Reviews</option></select>
