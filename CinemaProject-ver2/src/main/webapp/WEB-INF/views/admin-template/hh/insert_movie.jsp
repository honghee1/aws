	       ...
	       $.ajax({
	          ...
	          success:function(r){
	             ...
	             for(i=0;i<r.Data[0].Result.length;i++){
		             ...
		             title = title.replace(/ /g, "");
	                 tag += "<tr id=Line>";
	                 tag += "<td><button id=data1 class=data2 >선택하기</button></td>";
	                ...
	                tag += "<td style=display:none>" + r.Data[0].Result[i].kmdbUrl + "</td>";
	                tag += "</tr>";
	          }
	                  tag += "</form>"; 
	                  tag += "</div>"
...
<body>
		...
		<div class="form-group">
		<input type="text" name="directorNm" id="directorNm" value="${requestScope.mdto.directorNm }"class="form-input border-bottom" placeholder="감독(한)">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group">
		<input type="text" name="directorEnNm" id="directorEnNm" value="${requestScope.mdto.directorEnNm }"class="form-input border-bottom" placeholder="감독(영)">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group" style="width: 83%">
		<input type="text" name="actorNm" id="actorNm" value="${requestScope.mdto.actorNm }" class="form-input border-bottom" placeholder="배우(한)">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group" style="width: 83%">
		<input type="text" name="actorEnNm" id="actorEnNm" value="${requestScope.mdto.actorEnNm }" class="form-input border-bottom" placeholder="배우(영)">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group" style="width: 83%">
		<input type="text" name="company" id="company" value="${requestScope.mdto.company }" class="form-input border-bottom" placeholder="제작사">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group" style="width: 83%">
		<input type="text" name="keywords" id="keywords" value="${requestScope.mdto.keywords }"  class="form-input border-bottom" placeholder="키워드">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group">
		<input type="text"  name="nation" id="nation" value="${requestScope.mdto.nation }" class="form-input border-bottom" placeholder="국가">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group">
		<input type="text" name="genre" id="genre" value="${requestScope.mdto.genre }" class="form-input border-bottom" placeholder="장르">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group">
		<input type="text" name="runtime" id="runtime" value="${requestScope.mdto.runtime }" class="form-input border-bottom" placeholder="상영시간">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group">
		<input type="text" name="repRlsDate" id="repRlsDate" value="${requestScope.mdto.repRlsDate }" class="form-input border-bottom" placeholder="개봉일">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group" style="width: 41%">
		<input type="text" name="trailer" id="trailer" value="${requestScope.mdto.trailer }" class="form-input border-bottom" placeholder="예고편 링크 예고편 링크 *유튜브 공유 버튼을 눌러 링크를 복사해주세요">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group">
		...
		<div class="form-group" style="width: 41%">
		<input type="text"  name="rating" id="rating" value="${requestScope.mdto.rating }" class="form-input border-bottom" placeholder="관람 등급">
		<span class="border-bottom-animation left"></span>
		</div>
		<div class="form-group" style="width: 41%">
		<input type="text" name="kmdbUrl" id="kmdbUrl" value="${requestScope.mdto.kmdbUrl }" class="form-input border-bottom" placeholder="상세보기 페이지">
		<span class="border-bottom-animation left"></span>
		</div>
		</div>
		...
		<div class="form-group" >
		<p>줄거리</p>
		<textarea name="plotText"  id="plotText" rows="20" cols="65" name="plotText"  placeholder="${requestScope.mdto.plotText }"></textarea>
		</div>
		</div>
