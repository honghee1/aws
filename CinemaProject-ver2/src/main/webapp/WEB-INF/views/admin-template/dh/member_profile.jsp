									...
									<form action="updateQnaResponse.do" class="form-horizontal form-element">
										<div class="form-group row no-gutters">
											<div class="col-sm-9">
												...
												<input name="qnaTitle" type="hidden" value="${qna.qnaTitle }">
											</div>
											<div class="col-sm-3">
												<button type="submit"
									...
									<td colspan="7">
										<div class="page_bar">
											<c:if test="${pagging.previousPageGroup }">
												<a href="memberProfile.do?pageNo=${pagging.startPageOfPageGroup - 1 }&userEmail=${dto.userEmail}">◀</a>
											</c:if>
											<c:forEach var="i" begin="${pagging.startPageOfPageGroup}" 
											end="${pagging.endPageOfPageGroup}">
												<a href="memberProfile.do?pageNo=${i }&userEmail=${dto.userEmail}">${ i}</a>
											</c:forEach>
										
											<c:if test="${pagging.nextPageGroup }">
												<a href="memberProfile.do?pageNo=${pagging.endPageOfPageGroup + 1 }&userEmail=${dto.userEmail}">▶</a>
											</c:if>
										</div>
								</tr>
							</table>
				                ...
				                <div class="row">
				                  <div class="col-12">
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">이메일</label>
				                      <div class="col-sm-5"><input class="form-control" readonly="readonly" type="text" value="${dto.userEmail }" name="userEmail" placeholder="이메일"></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">비밀번호</label>
				                      <div class="col-sm-5"><input class="form-control" type="password" value="${dto.userPasswd }" name="userPasswd" placeholder="비밀번호"></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">이름</label>
				                      <div class="col-sm-5"><input class="form-control" type="text" value="${dto.userName }" name="userName" placeholder="이름"></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">닉네임</label>
				                      <div class="col-sm-5"><input class="form-control" type="text" value="${dto.userNick }" name="userNick" placeholder="이름"></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">생일</label>
				                      <div class="col-sm-5"><input class="form-control" type="date" value="${dto.userBirth }" name="userBirth" placeholder="이메일"></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">전화번호</label>
				                      <div class="col-sm-5"><input class="form-control" type="text" value="${dto.userTel }" name="userTel" placeholder="전화번호"></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">우편번호</label>
				                      	<div class="col-sm-5"><input class="form-control" id="sample6_postcode" type="text" value="${requestScope.address1 }" name="address1" readonly></div>
					                    <input type="button" class="btn btn-warning" onclick="sample6_execDaumPostcode()" value="우편번호 검색"><br>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">도로명주소</label>
				                      	<div class="col-sm-5"><input class="form-control" id="sample6_address" type="text" value="${requestScope.address2 }" name="address2" readonly></div>
				                    </div>
				                    <div class="form-group row"><label class="col-sm-2 col-form-label">상세주소</label>
				                      	<div class="col-sm-5"><input class="form-control" id="sample6_detailAddress" type="text" value="${requestScope.address3 }" name="address3"></div>
				                    </div>
