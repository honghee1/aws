...
<title>Crypto Admin - Dashboard Data Tables</title>
<!-- Bootstrap 4.0-->
<link rel="stylesheet"
...
<body class="hold-transition skin-yellow sidebar-mini">
		...
		<header class="main-header">
			...
			<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><img
					src="../../../images/logo-light-text.png" alt="logo"
					class="light-logo"><img
					src="../../../images/logo-dark-text.png" alt="logo"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="../../index.html"><i class="fa fa-dashboard"></i><span>Dashboard</span><span
					...
					<ul class="treeview-menu">
							...
							<li><a href="../reports/top-gainers-losers.html">Top
									Gainers/Losers</a></li>
							<li><a href="../reports/market-capitalizations.html">Market
					...
					<ul class="treeview-menu">
							...
							<li><a href="../ico/ico-filter.html">ICO Listing -
									Filters</a></li>
						</ul></li>
					<li><a href="../currency-ex/exchange.html"><i
					...
					<ul class="treeview-menu">
							...
							<li><a href="../members/member-profile.html">Member
									Profile</a></li>
						</ul></li>
					...
					<ul class="treeview-menu">
							...
							<li><a href="../tickers/crypto-live-pricing.html">Live
									Crypto Prices</a></li>
						</ul></li>
					<li class="treeview"><a href="#"><i class="icon-wallet"></i><span>Transactions</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
							<li><a href="../transactions/tables-transactions.html">Transactions
									Tables</a></li>
							<li><a href="../transactions/transaction-search.html">Transactions
									Search</a></li>
							<li><a href="../transactions/transaction-details.html">Single
									Transaction</a></li>
							<li><a href="../transactions/counter-transactions.html">Transactions
									Counter</a></li>
						</ul></li>
					...
					<ul class="treeview-menu">
							...
							<li><a href="../charts/rickshaw-charts.html">Rickshaw
									Charts</a></li>
							...
							<li><a href="../amcharts/amstock-charts.html">amCharts
									Stock Charts</a></li>
							<li><a href="../amcharts/ammaps.html">amCharts Maps</a></li>
						</ul></li>
					<li class="treeview"><a href="#"><i class="fa fa-th"></i><span>App</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
					...
					<li class="treeview"><a href="#"><i class="fa fa-envelope"></i><span>Mailbox</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
					...
					<ul class="treeview-menu">
							...
							<li><a href="../UI/bootstrap-switch.html">Bootstrap
									Switch</a></li>
							...
							<li><a href="../UI/portlet-draggable.html">Draggable
									Portlets</a></li>
							...
							<li><a href="../UI/timeline-horizontal.html">Horizontal
									Timeline</a></li>
						</ul></li>
					<li class="header nav-small-cap">FORMS, TABLE & LAYOUTS</li>
					<li class="treeview"><a href="#"><i class="fa fa-bars"></i><span>Widgets</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
					...
					<li class="treeview"><a href="#"><i class="fa fa-square-o"></i><span>Box</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
					...
					<ul class="treeview-menu">
							...
							<li><a href="../forms/form-validation.html">Form
									Validation</a></li>
					...
					<li class="treeview"><a href="#"><i class="fa fa-plug"></i><span>Extension</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
							<li><a href="../extension/fullscreen.html">Fullscreen</a></li>
						</ul></li>
					<li class="treeview"><a href="#"><i class="fa fa-file"></i><span>Sample
								Pages</span><span class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
							<li><a href="../samplepage/blank.html">Blank</a></li>
							<li><a href="../samplepage/coming-soon.html">Coming Soon</a></li>
							<li><a href="../samplepage/custom-scroll.html">Custom
									Scrolls</a></li>
							...
							<ul class="treeview-menu">
									...
									<li><a href="../samplepage/user-pass.html">Recover
											password</a></li>
								</ul></li>
					...
					<li class="treeview"><a href="#"><i class="fa fa-share"></i><span>Multilevel</span><span
							class="pull-right-container"><i
								class="fa fa-angle-right pull-right"></i></span></a>
					<ul class="treeview-menu">
					...
					<div class="col-12">
						<div class="box box-solid bg-dark">
							<div class="box-header with-border">
								...
								<h6 class="box-subtitle">Export data to Copy, CSV, Excel,
									PDF & Print</h6>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
	...
	<!-- DataTables -->
	<script
		src="../../../assets/vendor_components/datatables.net/js/jquery.dataTables.min.js"></script>
	<script
		src="../../../assets/vendor_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
	<!-- SlimScroll -->
	<script
	...
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/dataTables.buttons.min.js"></script>
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.flash.min.js"></script>
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/ex-js/jszip.min.js"></script>
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/ex-js/pdfmake.min.js"></script>
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/ex-js/vfs_fonts.js"></script>
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.html5.min.js"></script>
	<script
		src="../../../assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.print.min.js"></script>
