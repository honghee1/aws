...
public class NaverAPI {
	 public String getAccessToken(String code) throws UnsupportedEncodingException {
	      String clientId = "jgPU1Ccmjpw1Cg57ZBip";// 애플리케이션 클라이언트 아이디값";
	      String clientSecret = "hTcrzgcWUX";// 애플리케이션 클라이언트 시크릿값";
	      String redirectURI = URLEncoder.encode("http://localhost:9999/naverLogin.do", "UTF-8");
	      String apiURL;
